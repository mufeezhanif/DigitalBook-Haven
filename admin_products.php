         ...
         <div class="row " style="display: flex; justify-content:center;">
            ...
            ?>
                  <div class="box col-md-3 m-3 p-4 border">
                     ...
                     <div class="name">  <p><strong><?php echo $fetch_products['name']; ?></strong> </p></div>
                     <div class="name"> <p><?php echo $fetch_products['author']; ?> </p> </div>
                     <div class="name"> <p style="width:130px;overflow:hidden;white-space:nowrap; text-overflow:ellipsis;"><?php echo $fetch_products['description']; ?> </p> </div>
                     <div class="name"> <p><?php echo $fetch_products['category']; ?> </p> </div>
