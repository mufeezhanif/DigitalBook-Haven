...
if (isset($_POST["submitbtn"])) {
    ...
    $sql = "SELECT * FROM compa WHERE username = '{$username}' or email = '{$email}'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $query = "INSERT INTO compa (username,email,contact,subjects,topicname,`filename`,user_id) VALUES ('{$username}','{$email}','{$phone}','{$subject}','{$topic}','{$randomnum}{$filename}','{$user_id}')";
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Competition Registration</li>
                            </ol>
                        </nav>
                        ...
                        <div class="main-form pt-45">
                            <form action="" method="post" data-toggle="validator" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="singel-form form-group">
                                            <select name="subject" id="" class="w-100">
                                    ...
                                    <div class="col-md-6">
                                        <!-- Sign Up Link -->
                                        <div class="singel-form form-group">
                                            <label class="form-label" for="form1Example23">Are You A Child? Want to take part in essay competition?
                                                <a href="compkidform.php">Click Here</a></label>
                                        </div>
                                        <!-- singel form -->
                                    </div>
