...
if (isset($_POST["feedbacksubmit"])) {
    ...
    $query = "INSERT into feedback (username,useremail,suggestion,userid) values ('{$name}','{$email}','{$comment}',{$user_id})";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="singel-form">
                                            <button type="submit" name="feedbacksubmit" class="main-btn">Send</button>
                                        </div> <!-- singel form -->
                                    </div>
                                </div> <!-- row -->
                            </form>
